...
namespace Unit_Tests
{
    public class PurchaseControllerTest
    {
        ...
        public async Task GetAllTest()
        {
            ...
            PurchaseRepository repo1 = new PurchaseRepository(db);
            await repo1.CreateAsync(purchase1);
            await repo1.CreateAsync(purchase2);
            await repo1.CreateAsync(purchase3);

            PurchasesController controller = new PurchasesController(repo1);
